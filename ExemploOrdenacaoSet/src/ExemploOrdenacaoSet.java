...
public class ExemploOrdenacaoSet {
    public static void main(String[] args) throws Exception {
        ...
        Set<Serie> minhasSeries = new HashSet<>(){{
            add(new Serie("The Mentalist", "Suspense", 40));
            add(new Serie("Sherlock Holmes", "Suspense", 60));
        ...
        Set<Serie> minhasSeries3 = new TreeSet<>(new ComparatorNomeTempoEpisodio());
        ...
        class ComparatorNomeTempoEpisodio implements Comparator<Serie>{
